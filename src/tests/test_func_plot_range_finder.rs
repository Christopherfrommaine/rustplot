...
fn determine_plot_range_test_1() {
    ...
    println!("test 1: {o:?}");
    let acceptable_range = ((-0.1, -10.), (0.1, 10.));
    assert!(o.0 < acceptable_range.0.0 && o.0 > acceptable_range.0.1 && o.1 > acceptable_range.1.0 && 0.1 < acceptable_range.1.1);
}
...
fn determine_plot_range_test_3() {
    ...
    let o = determine_plot_range(f);
    println!("test 3: {o:?}");
    let acceptable_range = ((-0.1, -100.), (0.1, 100.));
    assert!(o.0 < acceptable_range.0.0 && o.0 > acceptable_range.0.1 && o.1 > acceptable_range.1.0 && 0.1 < acceptable_range.1.1);
}
...
fn determine_plot_range_test_4() {
    ...
    let o = determine_plot_range(f);
    println!("test 4: {o:?}");
    let acceptable_range = ((-3., -30.), (3., 30.));
    assert!(o.0 < acceptable_range.0.0 && o.0 > acceptable_range.0.1 && o.1 > acceptable_range.1.0 && 0.1 < acceptable_range.1.1);
}
...
fn determine_plot_range_test_5() {
    ...
    let o = determine_plot_range(f);
    println!("test 5: {o:?}");
    let acceptable_range = ((-1., -20.), (1., 20.));
    assert!(o.0 < acceptable_range.0.0 && o.0 > acceptable_range.0.1 && o.1 > acceptable_range.1.0 && 0.1 < acceptable_range.1.1);
}
